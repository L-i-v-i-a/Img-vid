...
export default function CreateAnimationScreen({ navigation }: any) {
  ...
  const handleCreateAnimation = async () => {
    ...
    try {
      ...
      if (!response.ok) {
        Alert.alert('Error', data.detail || 'Video generation failed');
        return;
      }

      Alert.alert('Success', 'Animation created successfully');
    ...
    <View style={styles.container}>
      ...
      <ScrollView style={styles.content}>
        <View style={styles.innerContent}>
          ...
          <Card style={styles.card}>
            <Card.Content>
              <Text style={styles.cardTitle}>2. Select Motion Type</Text>
